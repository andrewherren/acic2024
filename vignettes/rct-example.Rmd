...
Extract observation-level outputs of the model: Fitted values, predicted values under control, and the estimated treatment effects.
...
ggplot(aes(x=value, color=factor(subgroup=="Stress.Bad.Stress.Bad")), data=gather(subgroup_ates, key="subgroup"))+geom_density()
...
Deeper trees better approximate $\tau$ at the cost of complexity and a loss of
interpretability.
